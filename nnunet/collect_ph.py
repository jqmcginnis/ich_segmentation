...
def combine_csv_files(directory, output_file="combined_ph_data.csv"):
    try:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="combined_ph_data.csv", type=str, help="Name of the output CSV file.")
